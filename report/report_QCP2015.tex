...
In section \ref{sec:Grover} we've shown the results for the three different 

As we have seen in  the \textbf{dense matrix representation} is at a disadvantage in every sense. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{img/Grover_Memory_Performance_log.eps}

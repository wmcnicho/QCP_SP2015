...
/**
 * Functional representation of the phase gate
 * @author Michael Chiang
 *
 */
public class FSGate extends FGate{
	...
	/**
	 * Construct the phase gate in functional representation
	 ...
	 */
	public FSGate(int [] controlQbits, int targetQbit){
		...
		onResult.setElement(1, 0, 0.0, 1.0);
	}

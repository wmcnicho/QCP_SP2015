...
import simulator.FRGrover;
import simulator.MRegister;
...
public class QuantumGuiPanel extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == start_butt){
			...
			console.append("Starting Calculation...\n");
			...
			console.append("Calculation ended.\n");
			console.append("Total Runtime: "+runtimeMins+" min "+runtimeSecs+" sec "+runtimeMSecs+" msecs\n");
		}
		else{
		console.append("huh?");
		}
